...
export default function App(){
  const[token,setToken]=useState(()=>{
    const t=localStorage.getItem("ttp_token")||sessionStorage.getItem("ttp_token")||"";
    if(!t)return "";
    try{const p=JSON.parse(atob(t.split(".")[1]));if(p.exp&&p.exp*1000<Date.now()){localStorage.removeItem("ttp_token");sessionStorage.removeItem("ttp_token");return "";}return t;}
    catch{return t;}
  });
