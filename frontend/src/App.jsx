...
// ─── HELPERS ──────────────────────────────────────────────────────────────────
const getToken = () => localStorage.getItem("ttp_token") || sessionStorage.getItem("ttp_token") || "";
...
async function apiFetch(path, params = {}) {
  ...
  if (r.status === 401) { localStorage.removeItem("ttp_token"); window.location.reload(); }
